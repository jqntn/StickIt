...
public class InteractionPlatforms : MonoBehaviour
{
    ...
    private void OnCollisionStay(Collision c)
    {
        ...
        {
            PlatformAction(sj.gameObject.transform.parent.GetComponentInChildren<Player>().gameObject);
            //Debug.Log(sj.gameObject.transform.parent.GetComponentInChildren<Player>().gameObject.name);
        }
